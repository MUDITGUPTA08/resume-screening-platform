  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={`${isAnalysisExpanded ? 'Hide' : 'Show'} analysis for ${app.candidate.fullName}, score ${app.analysis.matchScore} of 100, ${app.analysis.verdict}`}
      ...
      >
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div
            role="img"
            aria-label={`Match score ${app.analysis.matchScore} out of 100`}
            className="w-12 h-12 rounded-full border-4 border-neutral-100 flex items-center justify-center relative shrink-0 sm:hidden"
          >
            <div
        ...
        <div className="hidden sm:flex items-center gap-3 shrink-0">
          <div
            role="img"
            aria-label={`Match score ${app.analysis.matchScore} out of 100`}
            className="w-14 h-14 rounded-full border-4 border-neutral-100 flex items-center justify-center relative"
          >
            <div
              className="absolute inset-0 rounded-full"
              style={{
      ...
      <div className="px-5 pb-4 flex items-center justify-between gap-3 border-t border-neutral-100 pt-3">
        ...
        <select
          ...
          aria-label={`Application status for ${app.candidate.fullName}`}
          className="px-2 py-1 bg-neutral-50 border border-neutral-200 rounded-md text-xs font-medium text-neutral-700 cursor-pointer focus:outline-hidden focus-visible:ring-2 focus-visible:ring-neutral-900"
        >
